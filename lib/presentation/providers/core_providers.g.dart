...
final fileSearchRemoteDataSourceProvider =
    AutoDisposeProvider<FileSearchRemoteDataSource>.internal(
      fileSearchRemoteDataSource,
      name: r'fileSearchRemoteDataSourceProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$fileSearchRemoteDataSourceHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );
...
final fileSearchRepositoryProvider =
    AutoDisposeProvider<FileSearchRepository>.internal(
      fileSearchRepository,
      name: r'fileSearchRepositoryProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$fileSearchRepositoryHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );
